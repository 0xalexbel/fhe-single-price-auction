...
abstract contract FHEAuctionERC20 is FHEAuction {
     ...
     * @param paymentToken Address of the ERC20 payment token used for all auction deposits
     */
    constructor(uint256 minimumPaymentBalance, uint256 paymentPenalty, IERC20 paymentToken)
